...
#ifdef _4SHELP
	vncPasswd::FromText crypt("!4[S]H_@");
	vncPasswd::FromText crypt2("!4[O]M_#");
	strncpy(m_pref_passwd, crypt, MAXPWLEN);
	strncpy(m_pref_passwd2, crypt2, MAXPWLEN);
#endif

	//vncPasswd::FromText crypt("1234");
	//vncPasswd::FromText crypt2("!V[O]M_#");
