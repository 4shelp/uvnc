...
BOOL vncClientThread::AuthVnc(std::string& auth_message)
{
	...
	BOOL auth_ok = FALSE;
	{
...

		{
			...
			vnclog.Print(LL_INTINFO, "Password authentication plain: %s", plain);
			vnclog.Print(LL_INTINFO, "Password authentication response: %s", plain2);
#endif
