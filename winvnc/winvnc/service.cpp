...
void wait_for_existing_process()
{
		...
		while ((hEvent = OpenEvent(EVENT_ALL_ACCESS, FALSE, "Global\\SessionEventUltra3")) != NULL) {
...
void monitor_sessions()
{
	...
	hEvent = CreateEvent(NULL, FALSE, FALSE, "Global\\SessionEventUltra3");
	hEventcad = CreateEvent(NULL, FALSE, FALSE, "Global\\SessionEventUltraCad3");
