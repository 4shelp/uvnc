...
extern bool G_1111;
// Constants
const UINT MENU_ADD_CLIENT_MSG_INIT = RegisterWindowMessage("Remote.AddClient.Message.Init");
const UINT MENU_ADD_CLIENT_MSG = RegisterWindowMessage("Remote.AddClient.Message");
const UINT MENU_AUTO_RECONNECT_MSG = RegisterWindowMessage("Remote.AddAutoClient.Message");
const UINT MENU_STOP_RECONNECT_MSG = RegisterWindowMessage("Remote.AddStopClient.Message");
const UINT MENU_STOP_ALL_RECONNECT_MSG = RegisterWindowMessage("Remote.AddStopAllClient.Message");
const UINT MENU_REPEATER_ID_MSG = RegisterWindowMessage("Remote.AddRepeaterID.Message");
...
const UINT MENU_TRAYICON_BALLOON_MSG = RegisterWindowMessage("Remote.TrayIconBalloon2.Message");
 

const UINT FileTransferSendPacketMessage = RegisterWindowMessage("Remote.Viewer.FileTransferSendPacketMessage");


const char *MENU_CLASS_NAME = "4shelpSupport";
...
LRESULT CALLBACK vncMenu::WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	default:
		...
		if (iMsg == MENU_ADD_CLIENT_MSG || iMsg == MENU_ADD_CLIENT_MSG_INIT)
		{
			...
			vnclog.Print(LL_INTINFO, "############### MENU_ADD_CLIENT_MSG::Password changed = %s", plain); //PGM
